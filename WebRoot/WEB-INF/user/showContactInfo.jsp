...
<table width="78%" height="100%" border="0" cellpadding="0" cellspacing="0">
 ...
 <li><a href="/FlowerShop/UserMessageCl?type=aftersearch" onClick="return CheckLogin(<%=user %>);">我要留言</a></li>
   ...
   <div class="content_right_top"><span>>>联系方式</span></div>
   
   <!-- 右下部分-->
   <div class="show_contact_info">
   <div class="contact_user">
   <table border="0"><tr><td style="font-size: 18px;font-weight: bold">花卉预定管理系统</td></tr><tr><td>联系人:  高xx &nbsp;（经理）</td></tr><tr><td><a href="/FlowerShop/UserClServlet?type=showcompany" style="color: blue;text-decoration: none;">查看系统概况</a></td></tr>
   </table>
   </div>
   <div class="contact_user_info">
   <table border="0">
   <tr><td>电话: 010-55558888</td></tr> <tr><td>移动电话: 13800000000</td></tr>
    <tr><td>传真: 010-55559999</td></tr> <tr><td>地址: CHINA</td></tr>
     <tr><td></td></tr>
   </table>
