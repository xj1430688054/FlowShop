	...
	function tijiao(){
		...
		if(checkLength() && checkText()){
			...
			if(xmlHttpRequest){	//创建成功
				...
				var url="/FlowerShop/AdminFlowerCl?type=tjknow&mytime="+new Date();
	...
	function chuli(){
			...
			if(xmlHttpRequest.readyState==4){		//HTTP就绪码为4  
				if(xmlHttpRequest.status==200){	//HTTP 状态码为200 说明服务器处理正确
					...
					//提示完后跳转到显示所有动态页面
					window.location.href="/FlowerShop/AdminFlowerCl?type=showFlowerKnowledge";
 ...
 <div class="menu">
  ...
  <ul>
   ...
   <ul><li><a href="/FlowerShop/AdminFlowerCl?type=reservedflower">预订花卉</a></li><li><a href="/FlowerShop/AdminFlowerCl?type=ok">交易花卉</a></li><li><a href="/FlowerShop/AdminCommentCl?type=showcomment">评价管理</a></li></ul>
  	...
  	<div class="user_info">当前所在>>添加花卉知识</div>
  	
  	<div class="user_message">
   	<div class="add_news">
   	<div class="message_title"><span>花卉知识标题: <input type="text" name="title" id="title"  onblur="return checkLength();"/><font style="margin-left:10px;">(提示:标题不宜太长)</font></div>
   	<div class="message_content1"><span>花卉知识内容</div>
