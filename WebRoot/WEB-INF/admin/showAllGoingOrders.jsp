...
<div class="menu">
  ...
  <ul>
   ...
   <div class="welcome">当前所在>>所有交易中的订单</div>
   ...
   <div class="ye">	
    <%
			...
			%>
				<a href='/FlowerShop/AdminFenyeCl?type=allgoingorders&pageNow=<%=pageNow-1 %>'>上一页</a>
			<% 
			}
    ...
    <%
    		...
    		%>
    			<a href='/FlowerShop/AdminFenyeCl?type=allgoingorders&pageNow=<%=i %>'>[<%=i %>]</a>
    		<%
    		}
     ...
     <%
			...
			%>
				<a href='/FlowerShop/AdminFenyeCl?type=allgoingorders&pageNow=<%=pageNow+1 %>'>下一页</a>
			<% 
			}
			//最后一页
			...
			%>
				<a href='/FlowerShop/AdminFenyeCl?type=allgoingorders&pageNow=<%=pageCount %>'>最后一页</a>
			<% 
			}
			%>
			<% 
